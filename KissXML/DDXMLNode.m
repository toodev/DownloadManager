...
+ (id)document {
    return [[(DDXMLDocument *)[DDXMLDocument alloc] initWithRootElement:nil] autorelease];
}

+ (id)documentWithRootElement:(DDXMLElement *)element {
    	return [[(DDXMLDocument *)[DDXMLDocument alloc] initWithRootElement:element] autorelease];
}
